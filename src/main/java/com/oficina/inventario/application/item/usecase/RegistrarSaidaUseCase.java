...
public class RegistrarSaidaUseCase implements UseCase<RegistrarMovimentacaoInput, ItemOutput> {

    private final ItemRepository itemRepository;
    private final MovimentacaoRepository movimentacaoRepository;

    public RegistrarSaidaUseCase(ItemRepository itemRepository, MovimentacaoRepository movimentacaoRepository) {
